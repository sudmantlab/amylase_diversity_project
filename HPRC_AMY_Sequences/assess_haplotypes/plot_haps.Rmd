...
### NOT PLOTTING THIS HERE BECAUSE I'll plot it WITH the tree below
...
#   facet_grid(hap_struc_d~.,scales="free_y",space = "free")
# 
# fn_out = paste(outdir,"/haplotype_structures_rep.pdf",sep="")
# 
# pdf(fn_out,width=4,height=6)
# print(g)
# dev.off()  
...
g=g+geom_gene_arrow(aes(xmin=rel_start2,
                    ...
                    #position=position_nudge(x=0,y=-.2),
                    size=.1)+
  # geom_text(aes(x=rel_start2+(rel_end2-rel_start2)/2,
  #                       label=bID),
  #                   size=1)+
  geom_gene_arrow(aes(xmin=tstart,
                        xmax=tend,
...
p_color_csv = read.table("/Users/petersudmant/Documents/science/sudmantlab/projects/ancient_DNA/amylase/amylase_diversity_project/HPRC_AMY_Sequences/AMY_MAP_graphs/AMY1A_principal_color.csv",header=T,sep=",",comment.char = "")
...
fn_out = "/Users/petersudmant/Documents/science/sudmantlab/projects/ancient_DNA/amylase/amylase_diversity_project/HPRC_AMY_Sequences/AMY_MAP_graphs/AMY1A_principal_color_UPDATE.csv"
