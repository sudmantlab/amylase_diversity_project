...
#### PLOT THE CLUSTERED haps used for 
t_graph_clusters = read.table("/Users/petersudmant/Documents/science/sudmantlab/projects/ancient_DNA/amylase/amylase_diversity_project/HPRC_AMY_Sequences/combined_y1_y2_analyses/graph_genotyping_clusters/output/clusters_processed.tsv",header=T,sep="\t",comment="") %>%
...
# missing 1,5 7
#HG04228 #1
#HG03710 HG03710.hifiasm_filt_pat.fa:h1tg000035l_103311655_103704662_0 #
#HG01928#1#JAGYVQ010000195.1_211_358290_0 7

t %>% filter(grepl("HG03710",sample_id))
```
