...
def main(bin_tsv,sam_tsv,outf,idx_sam):
    ...
    dot_df.to_csv(os.path.abspath(outf+"/"+idx_sam+".genotype.tsv"), sep = "\t", index=True)
    ...
    #for cosine similarity
    perf_df.to_csv(os.path.abspath(outf+"/"+idx_sam+".best_genotype.tsv"), sep = "\t", index=False)
...
if __name__ == '__main__':
    ...
    main(bin_tsv,sam_tsv,outf,idx_sam)
