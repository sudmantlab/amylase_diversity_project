...
rule odgi_extract:
	...
	input:
		rules.odgi_index.output
	output:
		'results/odgi_results/extract/AMY.subgraph.og'
	threads:
		config['odgi']['threads_odgi']
	resources:
		mem_mb = config['odgi']['mem_odgi']
...
#	output:
#		'results/odgi_results/subpaths/AMY.subpaths.txt'
#	threads:
#		config['odgi']['threads_odgi']
#	resources:
#		mem_mb = config['odgi']['mem_odgi']
...
rule odgi_subfasta:
	...
	input:
		rules.odgi_extract.output
	output:
		'results/odgi_results/subpaths/AMY.subpaths.fa.gz'
	threads:
		config['odgi']['threads_odgi']
	resources:
		mem_mb = config['odgi']['mem_odgi']
...
#		rules.odgi_extract.output
#	output:
#		'results/odgi_results/substats/AMY.substats.tsv'
#	threads:
#		config['odgi']['threads_odgi']
#	resources:
#		mem_mb = config['odgi']['mem_odgi']
