...
fn_out = "./output_figures/genotype_by_pop_1.pdf"
...
fn_out = "./output_figures/genotype_by_pop_2A.pdf"
...
fn_out = "./output_figures/genotype_by_pop_2B.pdf"
pdf(fn_out,width=1,height=4)
print(g)
dev.off()

fn_out = "./output_figures/genotype_by_pop_legend.pdf"
pdf(fn_out,width=1,height=4)
...
for (curr_gene in c("AMY1","AMY2A","AMY2B")){
  ...
  g=g+geom_point(aes(x=-age,y=cp,color=p2),alpha=.5,position=position_jitter(width=0,height=.1),size=.5)+
