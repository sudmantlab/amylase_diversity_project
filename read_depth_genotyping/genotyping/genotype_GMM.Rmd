...
genotype = function(to_gt, iters, label){
  ...
  final_resps = gt_likelihood_table(t_gt,k,mu,offset,sigma, pi, label)
...
AMY1_gt_trained = genotype(to_gt_train_AMY1, 20, "AMY1")
AMY2B_gt_trained = genotype(to_gt_train_AMY2B, 20, "AMY2B")
AMY2A_gt_trained = genotype(to_gt_train_AMY2A, 20, "AMY2A")
AMY2Ap_gt_trained = genotype(to_gt_train_AMY2Ap, 20, "AMY2Ap")
