...
t= lst_tab_no0rows_bm.0rows$AMY1A




lapply(lst_tab, function(X) X)<0)


lst_tab$AMY2B$dup = duplicated(lst_tab$AMY2B[, c("start")]) | duplicated(lst_tab$AMY2B[, c("end")])



# # collect the intensiteis from here https://ftp.1000genomes.ebi.ac.uk/vol1/ftp/technical/working/20110117_bi_omni_intensities/
# 
# # open them
# # fold intensities
# tab_int = "/project/alfredo/reference_data/1000G/genotype_chips/20110117_bi_omni_intensities/Omni25_norm_intensity_20110117.txt"
