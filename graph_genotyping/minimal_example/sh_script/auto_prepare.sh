...
if [ "$3" == "-hg19" ]; then
  ref=$(readlink -f ref/hg19/hs37d5.fa)
  pos="1:103998686-104406594"
else
  ref=$(readlink -f ref/hg38/GRCh38_full_analysis_set_plus_decoy_hla.fa)
  pos="chr1:103456064-103863972"    

fi

graph="$(readlink -f graph/selected_indivs_AMY_region.fa.gz.42c7330.417fcdf.8bc4b72.smooth.final.gfa)"
...
./cosigt_prepare.sh ${bam_cram_folder} ${ref} ${graph} ${pos} 
